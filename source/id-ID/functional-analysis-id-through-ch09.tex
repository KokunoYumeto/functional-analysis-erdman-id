...
\begin{document}
 ...
 \frontmatter
 \title{ANALISIS FUNGSIONAL \\ DAN \\ ALJABAR OPERATOR: \\ Suatu Pengantar \\ \mbox{} \\ \large Unit Pembaca Kumulatif Bab 1--9}
...
\begin{center}
\textbf{Edisi Bahasa Indonesia --- batas produksi Bab 1--9}
\end{center}
...
Perubahan pada batas ini: semua prosa pembaca dalam Bab 1 sampai Bab 9
