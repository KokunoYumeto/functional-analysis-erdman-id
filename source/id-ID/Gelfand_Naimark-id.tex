...
\begin{prop}\label{001312} Jika $a$ elemen swadjoin dari aljabar-$C^*$ beridentitas,
 \index{spektrum!elemen swadjoin}%
 \index{swadjoin!spektrum elemen}%
...
\begin{cor}\label{001406} Misalkan $A$ aljabar-$C^*$ komutatif beridentitas. Jika $a \in A$ swadjoin,
...
subaljabar pemisah, swadjoin, beridentitas dari~$\fml C(\Delta A)$.
\end{cor}
...
\begin{prop}[Teorema pemetaan spektral]\label{001446} Misalkan $a$ elemen swadjoin
...
dan $f\colon K \sto \C$ fungsi kontinu. Misalkan $\ofml H_K$ himpunan semua elemen swadjoin dari $A$ yang spektrumnya
