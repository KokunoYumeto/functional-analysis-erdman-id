...
\numberwithin{equation}{section}
 ...
 \newcommand{\futurexref}[2]{#1}
      % Printed number plus retained source label for a forward reference whose
      % destination is outside this partial reader boundary.
...
\begin{document}
 ...
 \frontmatter
 \title{ANALISIS FUNGSIONAL \\ DAN \\ ALJABAR OPERATOR: \\ Suatu Pengantar \\ \mbox{} \\ \large Unit Pembaca 1: Aljabar Linear dan Teorema Spektral}
...
\begin{center}
\textbf{Edisi Bahasa Indonesia --- batas produksi pertama}
\end{center}
...
Perubahan pada batas ini: semua prosa pembaca dalam Bab 1 diterjemahkan ke
Bahasa Indonesia; struktur, rumus, label, sitasi, latihan, dan penomoran sumber
dipertahankan. Epigraf pihak ketiga, gambar lencana lisensi, dan makro tabel
yang status komponennya tidak cukup jelas tidak digunakan. Berkas
