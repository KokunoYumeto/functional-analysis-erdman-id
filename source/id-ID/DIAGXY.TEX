 ...
 % amssymb, which should therefore be loaded first.
...
\domorphism(#1,#2)|#3|/#4/<#5,#6>[{#7}`{#8};{#9}]}
 ...
 %    \else
 %      \POS(#1,#2)*+!!<0ex,.75ex>{#7}\ar#4|-*+<1pt,4pt>{\labelstyle#9}
 %        (\xend,\yend)*+!!<0ex,.75ex>{#8}%
 %    \fi
 %  \else \if#3r%
 %   \ifnum #6<0%
 %    \POS(#1,#2)*+!!<0ex,.75ex>{#7}\ar#4^-{#9} (\xend,\yend)*+!!<0ex,.75ex>{#8}%
...
\def\pplace[#1](#2,#3)[#4]{\POS(#2,#3)*+!!<0ex,.75ex>!#1{#4}\ignorespaces}%
\def\cplace(#1,#2)[#3]{\POS(#1,#2)*+!!<0ex,.75ex>{#3}\ignorespaces}%
