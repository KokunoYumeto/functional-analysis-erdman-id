...
latexmk -C -outdir='../../qa/build-through-ch10-a' 'functional-analysis-id-through-ch10.tex'
latexmk -pdf -interaction=nonstopmode -halt-on-error -file-line-error `
  -outdir='../../qa/build-through-ch10-a' 'functional-analysis-id-through-ch10.tex'
```
...
PDFs. The current canonical Bab 1--10 reader artifact and its exact hash are
recorded in `provenance/CH10_BUILD_AND_QA_RECEIPT.md`. The frozen Bab 1--9, Bab
1--8, Bab 1--7, Bab
...
The current wrapper also loads `cmap` and Latin Modern so that all 45 font
resources carry Unicode mappings, fixes derivative PDF dates explicitly, and
