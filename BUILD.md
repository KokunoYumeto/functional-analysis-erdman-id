...
latexmk -C -outdir='../../qa/build-through-ch09-a' 'functional-analysis-id-through-ch09.tex'
latexmk -pdf -interaction=nonstopmode -halt-on-error -file-line-error `
  -outdir='../../qa/build-through-ch09-a' 'functional-analysis-id-through-ch09.tex'
```
...
canonical Bab 1--9 reader artifact and its exact hash are recorded in
`provenance/CH09_BUILD_AND_QA_RECEIPT.md`. The frozen Bab 1--8, Bab 1--7, Bab
