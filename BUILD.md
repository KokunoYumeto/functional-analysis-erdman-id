...
latexmk -C -outdir='../../qa/build-through-ch11-a' 'functional-analysis-id-through-ch11.tex'
latexmk -pdf -interaction=nonstopmode -halt-on-error -file-line-error `
  -outdir='../../qa/build-through-ch11-a' 'functional-analysis-id-through-ch11.tex'
```
...
PDFs. The current canonical Bab 1--11 reader artifact and its exact hash are
recorded in `provenance/CH11_BUILD_AND_QA_RECEIPT.md`. The frozen Bab 1--10,
