...
latexmk -C -outdir='../../qa/build-through-ch03' 'functional-analysis-id-through-ch03.tex'
latexmk -pdf -interaction=nonstopmode -halt-on-error -file-line-error `
  -outdir='../../qa/build-through-ch03' 'functional-analysis-id-through-ch03.tex'
```
...
canonical Bab 1--3 reader artifact and its exact hash are recorded in
`provenance/CH03_BUILD_AND_QA_RECEIPT.md`. The frozen Bab 1--2 and Unit 1
