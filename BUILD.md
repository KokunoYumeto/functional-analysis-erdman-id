...
latexmk -C -outdir='../../qa/build-through-ch08-a' 'functional-analysis-id-through-ch08.tex'
latexmk -pdf -interaction=nonstopmode -halt-on-error -file-line-error `
  -outdir='../../qa/build-through-ch08-a' 'functional-analysis-id-through-ch08.tex'
```
...
canonical Bab 1--8 reader artifact and its exact hash are recorded in
`provenance/CH08_BUILD_AND_QA_RECEIPT.md`. The frozen Bab 1--7, Bab 1--6, Bab 1--5, Bab
...
The current wrapper also loads `cmap` and Latin Modern so that all 43 font
