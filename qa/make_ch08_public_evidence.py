#!/usr/bin/env python3
"""Create compact public evidence from the complete private Chapter 8 render."""
...
PUBLIC_MANIFEST = ROOT / "provenance" / "CH08_RENDER_MANIFEST.csv"
CONTACT_SHEET = ROOT / "provenance" / "CH08_CONTACT_SHEET.png"
...
def main() -> None:
    ...
    if [page_number(path) for path in pages] != list(range(1, EXPECTED_PAGES + 1)):
        raise SystemExit("The private render is not the exact 129-page closure")
