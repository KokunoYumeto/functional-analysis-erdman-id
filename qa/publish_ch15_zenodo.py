#!/usr/bin/env python3
"""Publish the admitted Chapter 15 checkpoint in the existing Zenodo concept."""
...
release.EXPECTED_PREVIOUS_VERSION = "2026.08.24-ch14"
release.VERSION = "2026.08.24-ch15"
release.PDF_NAME = "analisis-fungsional-dan-aljabar-operator-id-bab-1-15.pdf"
release.ZIP_NAME = "functional-analysis-erdman-id-2026.08.24-ch15-source-backend.zip"
_base_writable_metadata = release.writable_metadata


def description(github_commit: str) -> str:
    return (
        "<p><strong>Status: edisi dalam pengerjaan, Bab 1-15 dari 17 bab.</strong> "
        "Versi ini menambahkan Bab 15, <em>Teori Fredholm</em>, kepada reader "
        "Bahasa Indonesia yang telah diverifikasi. Bab 16-17, reader HTML "
        ...
        "dipertahankan.</p>"
        "<p>PDF 200 halaman dapat ditelusuri dan dinavigasi; seluruh halaman "
