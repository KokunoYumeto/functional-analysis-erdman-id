#!/usr/bin/env python3
"""Inventory every Chapter 1--15 render and create all-page contact sheets."""
...
PDF = ROOT / "qa" / "build-through-ch15-final" / "functional-analysis-id-through-ch15.pdf"
RENDER = ROOT / "qa" / "render-through-ch15-final"
MANIFEST = ROOT / "provenance" / "CH15_RENDER_MANIFEST.csv"
SUMMARY = ROOT / "qa" / "CH15_RENDER_AUDIT.json"
SHEETS = RENDER / "contact-sheets"
EXPECTED_PAGES = 200
EXPECTED_SIZE = (935, 1210)
EXPECTED_PDF_BYTES = 2_156_827
EXPECTED_PDF_SHA256 = "5b8d5d5f44671f4695dea7f470d6ea7bb63fd2a0ff459aa8e8fb1a0c0faac7c7"
...
def main() -> None:
    ...
    summary = {
        "schema_version": "o008.ch15-render-audit.v1",
        "pdf": {
