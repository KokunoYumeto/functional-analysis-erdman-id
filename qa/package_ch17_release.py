#!/usr/bin/env python3
"""Build the deterministic Chapter 17 release with the established packager."""
...
release.RELEASE = "2026.08.24-ch17"
...
release.SCOPE = (
    "in progress; all 17 source-order chapters translated; front/back matter, "
    "semantic accessibility, mastery, and compact-spectral/SVD bridge remain"
)
