#!/usr/bin/env python3
"""Inventory every Chapter 1--14 render and create all-page contact sheets."""
...
PDF = ROOT / "qa" / "build-through-ch14-final" / "functional-analysis-id-through-ch14.pdf"
RENDER = ROOT / "qa" / "render-through-ch14-final"
MANIFEST = ROOT / "provenance" / "CH14_RENDER_MANIFEST.csv"
SUMMARY = ROOT / "qa" / "CH14_RENDER_AUDIT.json"
SHEETS = RENDER / "contact-sheets"
EXPECTED_PAGES = 193
EXPECTED_SIZE = (935, 1210)
EXPECTED_PDF_BYTES = 2_104_187
EXPECTED_PDF_SHA256 = "3e82aca29ea623502e6ce5b2059238088d8e5b6f81d699463402aff16fe15b41"
...
def main() -> None:
    ...
    summary = {
        "schema_version": "o008.ch14-render-audit.v1",
        "pdf": {
