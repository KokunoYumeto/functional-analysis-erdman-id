#!/usr/bin/env python3
"""Create compact public evidence from the complete private Chapter 7 render."""
...
PUBLIC_MANIFEST = ROOT / "provenance" / "CH07_RENDER_MANIFEST.csv"
CONTACT_SHEET = ROOT / "provenance" / "CH07_CONTACT_SHEET.png"
...
def main() -> None:
    ...
    if [page_number(path) for path in pages] != list(range(1, EXPECTED_PAGES + 1)):
        raise SystemExit("The private render is not the exact 121-page closure")
