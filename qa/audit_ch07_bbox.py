#!/usr/bin/env python3
"""Audit Poppler Chapter 1--7 word boxes without trusting control bytes as XML."""
...
BBOX = ROOT / "qa" / "renders" / "ch07-final" / "functional-analysis-id-through-ch07-bbox.html"
EXPECTED_PAGES = 121
