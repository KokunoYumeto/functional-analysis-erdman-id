#!/usr/bin/env python3
"""Anonymously verify the public Chapter 15 Zenodo record and file bytes."""
...
RECORD_ID = "22074877"
CONCEPT_ID = "22059739"
VERSION = "2026.08.24-ch15"
DOI = "10.5281/zenodo.22074877"
FILES = {
    "analisis-fungsional-dan-aljabar-operator-id-bab-1-15.pdf": ROOT
    / "output"
    / "pdf"
    / "analisis-fungsional-dan-aljabar-operator-id-bab-1-15.pdf",
    "functional-analysis-erdman-id-2026.08.24-ch15-source-backend.zip": ROOT
    / "qa"
    / "release-ch15"
    / "functional-analysis-erdman-id-2026.08.24-ch15-source-backend.zip",
    "SHA256SUMS.txt": ROOT / "qa" / "release-ch15" / "SHA256SUMS.txt",
}
RECEIPT = ROOT / "provenance" / "ZENODO_PUBLICATION_RECEIPT_CH15.json"
...
def main() -> None:
    ...
    result = {
        ...
        "receipt_id": "FAOA-2015-CH15-ZENODO-PUBLICATION",
