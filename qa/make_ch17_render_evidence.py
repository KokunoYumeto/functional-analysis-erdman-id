#!/usr/bin/env python3
"""Inventory every Chapter 1--17 render and create all-page contact sheets."""
...
BUILD_RESULT = ROOT / "qa" / "CH17_FINAL_BUILD_RESULT.json"
PDF = ROOT / "qa" / "build-through-ch17-final" / "functional-analysis-id-through-ch17.pdf"
RENDER = ROOT / "qa" / "render-through-ch17-final"
MANIFEST = ROOT / "provenance" / "CH17_RENDER_MANIFEST.csv"
SUMMARY = ROOT / "qa" / "CH17_RENDER_AUDIT.json"
...
def main() -> None:
    ...
    summary = {
        "schema_version": "o008.ch17-render-audit.v1",
        "pdf": {
