#!/usr/bin/env python3
"""Inventory every Chapter 1--16 render and create all-page contact sheets."""
...
BUILD_RESULT = ROOT / "qa" / "CH16_FINAL_BUILD_RESULT.json"
PDF = ROOT / "qa" / "build-through-ch16-final" / "functional-analysis-id-through-ch16.pdf"
RENDER = ROOT / "qa" / "render-through-ch16-final"
MANIFEST = ROOT / "provenance" / "CH16_RENDER_MANIFEST.csv"
SUMMARY = ROOT / "qa" / "CH16_RENDER_AUDIT.json"
...
def main() -> None:
    ...
    summary = {
        "schema_version": "o008.ch16-render-audit.v1",
        "pdf": {
