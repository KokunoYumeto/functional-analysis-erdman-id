#!/usr/bin/env python3
"""Inventory every Chapter 1--12 render and create all-page contact sheets."""
...
PDF = ROOT / "qa" / "build-through-ch12-final" / "functional-analysis-id-through-ch12.pdf"
RENDER = ROOT / "qa" / "render-through-ch12-final"
MANIFEST = ROOT / "provenance" / "CH12_RENDER_MANIFEST.csv"
SUMMARY = ROOT / "qa" / "CH12_RENDER_AUDIT.json"
SHEETS = RENDER / "contact-sheets"
EXPECTED_PAGES = 179
EXPECTED_SIZE = (935, 1210)
EXPECTED_PDF_BYTES = 2_001_449
EXPECTED_PDF_SHA256 = "476b1f1fd6ca82deddeeb9edac1b07286567ede5663a6df32906a36dd3ea5ab6"
...
def main() -> None:
    ...
    summary = {
        "schema_version": "o008.ch12-render-audit.v1",
        "pdf": {
