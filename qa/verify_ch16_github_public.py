#!/usr/bin/env python3
"""Anonymously verify the Chapter 16 GitHub commit and all changed bytes."""
...
BRANCH = "main"
RECEIPT = ROOT / "provenance" / "GITHUB_PUBLICATION_RECEIPT_CH16.json"
REPRESENTATIVE = {
    "README.md",
    "source/id-ID/extensions-id.tex",
    "output/pdf/analisis-fungsional-dan-aljabar-operator-id-bab-1-16.pdf",
    "provenance/CH16_BUILD_AND_QA_RECEIPT.md",
...
def main() -> None:
    ...
    result = {
        ...
        "receipt_id": "FAOA-2015-CH16-GITHUB-PUBLICATION",
