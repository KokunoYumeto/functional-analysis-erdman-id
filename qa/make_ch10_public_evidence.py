#!/usr/bin/env python3
"""Create compact public evidence from the complete private Chapter 10 render."""
...
PUBLIC_MANIFEST = ROOT / "provenance" / "CH10_RENDER_MANIFEST.csv"
CONTACT_SHEET = ROOT / "provenance" / "CH10_CONTACT_SHEET.png"
...
def main() -> None:
    ...
    if [page_number(path) for path in pages] != list(range(1, EXPECTED_PAGES + 1)):
        raise SystemExit("The private render is not the exact 153-page closure")
